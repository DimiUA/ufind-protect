...
API_URL.URL_GET_LOGOUT = API_DOMIAN1 + "Logoff?MinorToken={0}&deviceToken={1}";
...
function recharge(){
    ...
    mainView.router.load({
        ...
        context:{
            userCode: MinorToken,
            dealerNumber: 16,    // 2 - means M-Protekt
            other: 'UFind-Protect-app',
            button10: button10,
            button50: button50,
            button100: button100,
            buttonCur: buttonCur
